...
@section('title', 'Laporan Jasa Distribusi & Pemasaran')
@section('header', 'Laporan Jasa Distribusi & Pemasaran')
@section('menuopen0','menu-open')
@section('action1','active')
@section('action12','active')
@section('address')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
    <li class="breadcrumb-item active">Jasa Distribusi & Pemasaran</li>
</ol>
@endsection
@section('content')
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center bg-light mt-4 mb-5 pt-3 px-3 mx-0" style="border-radius: 5px;">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        <a href="{{route('laporan.distribusi')}}" class="btn btn-default btn-sm"><i class="fas fa-sm fa-sync-alt"></i></a>
                    </div>
                    </form>
                </div>
...
<script>
    ...
    var options = {
        ...
        xaxis: {
            categories: ['Jasa Distribusi & Pemasaran'],
