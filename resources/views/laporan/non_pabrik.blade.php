...
@section('title', 'Laporan Jasa Non Pabrik')
@section('header', 'Laporan Jasa Non Pabrik')
@section('menuopen0','menu-open')
@section('action1','active')
@section('action13','active')
@section('address')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
    <li class="breadcrumb-item active">Jasa Non Pabrik</li>
</ol>
@endsection
@section('content')
<div class="row">
        ...
        <div class="card card-navy">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center bg-light mt-4 mb-5 pt-3 px-3 mx-0" style="border-radius: 5px;">
                    <div class="col-md-5">
                        <form action="{{route('laporan.nonpabrik')}}" method="GET">
                    ...
                    <div class="col-md-2 text-right">
                        ...
                        <a href="{{route('laporan.nonpabrik')}}" class="btn btn-default btn-sm"><i class="fas fa-sm fa-sync-alt"></i></a>
                    </div>
                    </form>
                </div>
                <!-- ROW 1 -->
