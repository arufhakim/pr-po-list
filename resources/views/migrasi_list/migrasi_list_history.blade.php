...
@section('title', 'Migrasi PR-PO List')
@section('header', 'Migrasi PR-PO List')
@section('action8','active')
@section('address')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
    <li class="breadcrumb-item active">Migrasi PR-PO List</li>
</ol>
@endsection
@section('content')
<style>
...
<div class="row">
    @include('alert_import')
    <div class="col-12">
        <div class="card card-navy">
            <div class="card-header" style="line-height: 10px;">
                <h3 class="card-title" style="font-size: 15px; font-weight: bolder;">History Migrasi PR-PO List</h3>
                <!-- tool -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 text-left">
                        <a href="#" class="btn btn-primary btn-sm mb-4" data-toggle="modal" data-target="#add"><span style="font-weight:bolder">Migrasi PR-PO List</span></a>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-hover datatable table-bordered table-sm table-hide-overflow">
                        ...
                        <tbody>
                            @foreach($migrasi_list as $migrasi)
                            <tr>
                                <td align="center">{{$loop->iteration}}</td>
                                <td><a href="{{route('list_file_download', ['migrasi' => $migrasi->id])}}">{{$migrasi->file}}</a></td>
                                <td>{{$migrasi->created_by}}</td>
                                <td align="center">{{\Carbon\Carbon::parse($migrasi->created_at)->format('d/m/Y H:i:s')}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #001f3f; color: white;">
                <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px; font-weight:bolder;">Migrasi PR-PO List</h5>
            ...
            <form action="{{route('migrasi_list')}}" method="POST" enctype="multipart/form-data">
                <div class="modal-body py-2 px-0" style="background-color: #f4f6f9;">
                    <div class="row flex-column mr-3 ml-3">
                        @csrf
                        @method('post')
                        <div class="form-group">
                            <label class="col-form-label col-form-label-sm" for="file">File PR-PO List<span class="required">*</span></label>
                    ...
                    <div class="modal-footer pt-2 pb-0" style="background-color: #f4f6f9;">
                        <div class="row w-100">
                            <div class="col-12 d-flex justify-content-end pr-0">
                                <a href="{{asset('/file/Migrasi_PR_PO_List.xlsx')}}" class="btn btn-primary btn-sm mr-1"><span style="font-weight:bolder">Download Template</span></a>
