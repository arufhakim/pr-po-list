...
@section('header', 'Import Rekanan')
@section('action7','active')
@section('action74','active')
@section('menuopen3','menu-open')
@section('address')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
    <li class="breadcrumb-item active">Import Rekanan</li>
</ol>
@endsection
@section('content')
<style>
    ...
    <div class="col-12">
        <div class="card card-navy">
            <div class="card-header" style="line-height: 10px;">
                <h3 class="card-title" style="font-size: 15px; font-weight: bolder;">History Import Rekanan</h3>
                <!-- tool -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 text-left">
                        <a href="#" class="btn btn-primary btn-sm mb-4" data-toggle="modal" data-target="#add"><span style="font-weight:bolder">Import Rekanan</span></a>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-hover datatable table-bordered table-sm table-hide-overflow">
                        ...
                        <tbody>
                            @foreach($importv as $import)
                            <tr>
                                <td align="center">{{$loop->iteration}}</td>
                                <td><a href="{{route('vendor_file_download', ['importv' => $import->id])}}">{{$import->file}}</a></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #001f3f; color: white;">
                <h5 class="modal-title" id="exampleModalLabel" style="font-size: 15px; font-weight:bolder;">Import Rekanan</h5>
            ...
            <form action="{{route('import_vendor')}}" method="POST" enctype="multipart/form-data">
                <div class="modal-body py-2 px-0" style="background-color: #f4f6f9;">
                    <div class="row flex-column mr-3 ml-3">
                        @csrf
                        @method('post')
                        <div class="form-group">
                            <label class="col-form-label col-form-label-sm" for="file">File Rekanan<span class="required">*</span></label>
                    ...
                    <div class="modal-footer pt-2 pb-0" style="background-color: #f4f6f9;">
                        <div class="row w-100">
                            <div class="col-12 d-flex justify-content-end pr-0">
                                <a href="{{asset('/file/Import_Rekanan.xlsx')}}" class="btn btn-primary btn-sm mr-1"><span style="font-weight:bolder">Download Template </span></a>
